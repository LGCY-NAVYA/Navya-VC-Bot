...
async def song(client, message: Message):
    ...
    if not urlissed:
        ...
        return
    pablo = await client.send_message(message.chat.id, f"**𝑺𝒆𝒂𝒓𝒄𝒉𝒊𝒏𝒈**\n\n0% ▓▓▓▓▓▓▓▓▓▓▓▓ 100% ...** `{urlissed}`", reply_to_message_id=reply_id)
...
async def vsong(client, message: Message):
    ...
    try:
        ...
        await event.edit(event, f"**𝑫𝒐𝒘𝒏𝒍𝒐𝒂𝒅 𝑭𝒂𝒊𝒍𝒆𝒅** \n**Error :** `{str(e)}`")
        return
    c_time = time.time()
